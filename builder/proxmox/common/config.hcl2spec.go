// Code generated by "mapstructure-to-hcl2 -type Config,nicConfig,diskConfig,vgaConfig,additionalISOsConfig,interfaceConfig"; DO NOT EDIT.
...
type FlatConfig struct {
	...
	VMInterface               *FlatinterfaceConfig       `mapstructure:"vm_interface" cty:"vm_interface" hcl:"vm_interface"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"vm_interface":                 &hcldec.BlockSpec{TypeName: "vm_interface", Nested: hcldec.ObjectSpec((*FlatinterfaceConfig)(nil).HCL2Spec())},
	}
	return s
}
...
// FlatinterfaceConfig is an auto-generated flat version of interfaceConfig.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatinterfaceConfig struct {
	VMInterface *string `mapstructure:"interface" cty:"interface" hcl:"interface"`
	VMIPv6      *bool   `mapstructure:"ipv6" cty:"ipv6" hcl:"ipv6"`
}

// FlatMapstructure returns a new FlatinterfaceConfig.
// FlatinterfaceConfig is an auto-generated flat version of interfaceConfig.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*interfaceConfig) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatinterfaceConfig)
}

// HCL2Spec returns the hcl spec of a interfaceConfig.
// This spec is used by HCL to read the fields of interfaceConfig.
// The decoded values from this spec will then be applied to a FlatinterfaceConfig.
func (*FlatinterfaceConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
